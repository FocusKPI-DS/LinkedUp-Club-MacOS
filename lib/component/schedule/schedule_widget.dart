...
class _ScheduleWidgetState extends State<ScheduleWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.date = await actions.seperateDate(
        widget.startDate,
        widget.endDate,
      );
    });
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Builder(
                            builder: (context) {
                              final speaker = widget.speakers!.toList();
                              ...
                              return ListView.separated(
                                ...
                                itemBuilder: (context, speakerIndex) {
                                  final speakerItem = speaker[speakerIndex];
                                  return InkWell(
                                    splashColor: Colors.transparent,
                                    focusColor: Colors.transparent,
                                    hoverColor: Colors.transparent,
                                    ...
                                    onTap: () async {
                                      if (_model.speakers
                                        ...
                                        _model.removeFromSpeakers(speakerItem);
                                        safeSetState(() {});
                                      } else {
                                        _model.addToSpeakers(speakerItem);
                                        safeSetState(() {});
                                      }
                                    },
                                    child: Container(
