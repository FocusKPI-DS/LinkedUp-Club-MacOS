...
/// Create a component about the filter.
///
/// I want it to have the select the start time, sort new and old, category
class FilterSearchWidget extends StatefulWidget {
  ...
  final Future Function(DateTime? startTIme, String? category,
      DateTime? endTime, LatLng? location)? action;
