  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      constraints: const BoxConstraints(
        minWidth: 320.0, // Chewie material controls need ~282px; 320 avoids overflow
        maxWidth: 320.0,
        maxHeight: 400.0,
      ),
      decoration: BoxDecoration(
      ...
      child: ClipRRect(
        ...
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            // Ensure minimum size (150 for display, 320 so Chewie controls bar doesn't overflow)
            const minWidthForControls = 320.0;
            if (width < 150.0) {
              width = 150.0;
            ...
            if (width < minWidthForControls) {
              width = minWidthForControls;
              height = width / aspectRatio;
            }
