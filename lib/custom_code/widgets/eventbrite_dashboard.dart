...
class _EventbriteDashboardState extends State<EventbriteDashboard> {
  ...
  Map<String, bool> _syncingEvents = {};
  ...
  Future<void> _syncEvent(Map<String, dynamic> event) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Event synced successfully!'),
  ...
  Future<void> _handleSwitchAccount() async {
    ...
    final bool? shouldSwitch = await showDialog<bool>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Switch EventBrite Account?'),
          content: Text(
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Failed to switch accounts. Please try again.'),
          backgroundColor: FlutterFlowTheme.of(context).error,
        ),
      );
    }
