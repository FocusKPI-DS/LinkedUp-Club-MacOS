  ...
  try {
    ...
    if (inviteQuery.docs.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text('Invalid or already used invitation code'),
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content:
            const Text('Account upgraded successfully! You now have full access.'),
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: const Text('Failed to upgrade account. Please try again.'),
        backgroundColor: FlutterFlowTheme.of(context).error,
      ),
    );
    return false;
