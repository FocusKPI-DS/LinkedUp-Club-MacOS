  ...
  try {
    ...
    try {
      ...
      if (userData != null) {
        ...
        if (userData['new_message_enabled'] == null) {
          updates['new_message_enabled'] = true;
        }
        if (userData['connection_requests_enabled'] == null) {
      ...
      print('⚠️ Failed to set default notification preferences: $e');
    }
