...
class MessagesRecord extends FirestoreRecord {
  ...
  // "forwarded_history" field.
  String? _forwardedHistory;
  String get forwardedHistory => _forwardedHistory ?? '';
  bool hasForwardedHistory() => _forwardedHistory != null;
  ...
  /// Returns 'qurio_ai' if this message was sent via a personal API key through Qurio.
  String? get sentVia => snapshotData['sent_via'] as String?;
  ...
  void _initializeFields() {
    ...
    _forwardedHistory = snapshotData['forwarded_history'] as String?;
...
Map<String, dynamic> createMessagesRecordData({
  ...
  final firestoreData = mapToFirestore(
    <String, dynamic>{
      ...
      'is_pinned': isPinned,
      'forwarded_history': forwardedHistory,
    }.withoutNulls,
  );
...
class MessagesRecordDocumentEquality implements Equality<MessagesRecord> {
  ...
  bool equals(MessagesRecord? e1, MessagesRecord? e2) {
    ...
    return e1?.senderRef == e2?.senderRef &&
        ...
        e1?.forwardedHistory == e2?.forwardedHistory;
  }
