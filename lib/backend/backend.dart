...
import 'schema/chat_folders_record.dart';
import 'dart:async';
...
export 'schema/chat_folders_record.dart';
...
Stream<List<AnnouncementsRecord>> queryAnnouncementsRecord({
  ...
  bool singleRecord = false,
    ...
    queryCollection(
      AnnouncementsRecord.collection(parent),
...
/// Functions to query ChatFoldersRecords (as a Stream and as a Future).
Stream<List<ChatFoldersRecord>> queryChatFoldersRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      ChatFoldersRecord.collection(parent),
      ChatFoldersRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ChatFoldersRecord>> queryChatFoldersRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
