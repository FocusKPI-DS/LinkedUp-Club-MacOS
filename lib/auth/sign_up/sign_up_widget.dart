...
class SignUpWidget extends StatefulWidget {
  const SignUpWidget({
    ...
    bool? skippedInvite,
        ...
        skippedInvite = skippedInvite ?? false;

  final bool isDeeplink;
  final bool skippedInvite;
...
class _SignUpWidgetState extends State<SignUpWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (widget.skippedInvite == true) {
        _model.isSuccess = await actions.registerWithoutInvitation(
          context,
        );
      }
    });
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      // Hide social login options when embedded in Qurio
