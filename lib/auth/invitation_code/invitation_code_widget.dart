...
import 'invitation_code_model.dart';
export 'invitation_code_model.dart';

class InvitationCodeWidget extends StatefulWidget {
  ...
  static String routeName = 'InvitationCode';
  static String routePath = '/invitationCode';

  @override
  State<InvitationCodeWidget> createState() => _InvitationCodeWidgetState();
}

class _InvitationCodeWidgetState extends State<InvitationCodeWidget>
    with TickerProviderStateMixin {
  late InvitationCodeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InvitationCodeModel());
      ...
      if (widget.isDeeplink == true) {
        safeSetState(() {
          _model.emailAddressTextController?.text =
              FFAppState().DeeplinkInfo.invitationCode;
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        if (widget.isDeeplink == true) {
                                          ...
                                          _model.code =
                                              await queryInvitationCodeRecordOnce();
                                          if (_model.code!
                                              .where((e) =>
                                                  e.code ==
                                                  _model
                                ...
                                SizedBox(
                                  width: double.infinity,
                                  height: 50.0,
                                  child: custom_widgets.InvitationSkipButton(
                                    width: double.infinity,
                                    height: 50.0,
                                    onSkip: () async {},
                                  ),
                        ...
                        // Create a new pop up to send the email
                        Builder(
