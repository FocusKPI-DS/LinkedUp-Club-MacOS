...
class _FeedWidgetState extends State<FeedWidget> {
  ...
  /// Cached future so we don't refetch posts on every rebuild (was hammering Firestore).
  Future<List<PostsRecord>>? _postsFuture;
  ...
  void initState() {
    ...
    // Initial loading delay (keep existing behavior)
