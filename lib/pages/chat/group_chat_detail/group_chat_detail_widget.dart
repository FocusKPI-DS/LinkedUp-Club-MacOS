...
class _GroupChatDetailWidgetState extends State<GroupChatDetailWidget>
  ...
  Widget _buildFirefliesSection(ChatsRecord? currentChatDoc) {
    final isAdmin = currentChatDoc?.admin == currentUserReference;
                                                                          ...
                                                                          return InkWell(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                if (currentChatDoc?.admin == currentUserReference || currentChatDoc?.createdBy == currentUserReference)
                                                                                  PopupMenuButton<String>(
                                                                                    ...
                                                                                    itemBuilder: (context) => [
                                                                                      if (rowUsersRecord.reference != currentUserReference && rowUsersRecord.reference != currentChatDoc?.admin && rowUsersRecord.reference != currentChatDoc?.createdBy)
                                                                                        PopupMenuItem<String>(
                                                                                          value: 'make_admin',
                                                                                          child: Row(
                                                                                            children: [
