                                                                              ...
                                                                              children: [
                                                                                      ...
                                                                                      children: [
                                                                                        Row(
                                                                                          ...
                                                                                          children: [
                                                                                            ...
                                                                                            if (ChatHelpers.isGroupAdmin(widget.chatDoc, rowUsersRecord.reference))
                                                                                              Padding(
                                                                                ...
                                                                                if (ChatHelpers.isGroupAdmin(currentChatDoc, currentUserReference))
                                                                                  PopupMenuButton<String>(
                                                                                    ...
                                                                                    itemBuilder: (context) => [
                                                                                      if (rowUsersRecord.reference != currentUserReference && !ChatHelpers.isGroupAdmin(currentChatDoc, rowUsersRecord.reference))
                                                                                        PopupMenuItem<String>(
                                                                                          value: 'make_admin',
                                                                                          child: Row(
                                                                                            children: [
                                                                                      ...
                                                                                      if (rowUsersRecord.reference != currentUserReference && rowUsersRecord.reference != currentChatDoc?.createdBy)
                                                                                        PopupMenuItem<String>(
                                                                                          value: 'remove_user',
                                                                                          child: Row(
                                                                                            children: [
