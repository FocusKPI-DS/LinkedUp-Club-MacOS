...
class TaskReminderDigestCard extends StatefulWidget {
  ...
  /// When false, the card starts collapsed (only header visible). Defaults to true for chat thread.
...
class _TaskReminderDigestCardState extends State<TaskReminderDigestCard> {
  ...
  static String? _actionItemPathFromTask(Map<String, dynamic> t) {
    ...
    if (refRaw is String) {
      ...
      path = refRaw.path;
    } else if (refRaw is Map && refRaw['path'] != null) {
      path = refRaw['path'] is String ? refRaw['path'] as String : null;
    } else {
      return null;
    }
                  ...
                  children: [
                    ...
                    ...widget.tasks.asMap().entries.map((entry) {
                      ...
                      final String? actionItemRefPath = refRaw is String
                          ...
                          : (refRaw is DocumentReference
                              ? refRaw.path
                              : (refRaw is Map && refRaw['path'] != null
                                  ? (refRaw['path'] is String
                                      ? refRaw['path'] as String
                                      : null)
                                  : null));
