                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              if (FFAppState().chatSearch.length >= 1)
                                Builder(
                                  builder: (context) {
                                                                        ...
                                                                        children: [
                                                                          Row(
                                                                            mainAxisSize:
                                                                                MainAxisSize.max,
                                                                            children: [
                                                                              if (chatResultsItem.lastMessage != null && chatResultsItem.lastMessage != '')
                                                                                Text(
                                                                              ...
                                                                              Text(
                                                                                chatResultsItem.lastMessage == null || chatResultsItem.lastMessage == ''
                                                                                    ? 'Let\'s start a chat!'
