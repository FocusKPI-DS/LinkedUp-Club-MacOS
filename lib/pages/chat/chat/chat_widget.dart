                                                                                                  ...
                                                                                                  Stack(
                                                                                                    children: [
                                                                                                      Row(
                                                                                                        mainAxisSize: MainAxisSize.max,
                                                                                                        children: [
                                                                                                          if (allChatPinItem.lastMessage != null && allChatPinItem.lastMessage != '')
                                                                                                            Text(
                                                                                                              valueOrDefault<String>(
                                                                                                          ...
                                                                                                          Text(
                                                                                                            valueOrDefault<String>(
                                                                                                              allChatPinItem.lastMessage == null || allChatPinItem.lastMessage == ''
                                                                                                                  ? 'Let\'s start a chat!'
                                                                                                                  : valueOrDefault<String>(
                                                                                                  ...
                                                                                                  Stack(
                                                                                                    children: [
                                                                                                      Row(
                                                                                                        mainAxisSize: MainAxisSize.max,
                                                                                                        children: [
                                                                                                          if (allChatAllItem.lastMessage != null && allChatAllItem.lastMessage != '')
                                                                                                            Text(
                                                                                                              valueOrDefault<String>(
                                                                                                          ...
                                                                                                          Text(
                                                                                                            valueOrDefault<String>(
                                                                                                              allChatAllItem.lastMessage == null || allChatAllItem.lastMessage == ''
                                                                                                                  ? 'Let\'s start a chat!'
                                                                                                                  : valueOrDefault<String>(
                                                                                      ...
                                                                                      Stack(
                                                                                        children: [
                                                                                          Row(
                                                                                            mainAxisSize: MainAxisSize.max,
                                                                                            children: [
                                                                                              if (chatVarItem.lastMessage != null && chatVarItem.lastMessage != '')
                                                                                                Text(
                                                                                              ...
                                                                                              Text(
                                                                                                chatVarItem.lastMessage == null || chatVarItem.lastMessage == ''
                                                                                                    ? 'Let\'s start a chat!'
                                                                                                    : valueOrDefault<String>(
