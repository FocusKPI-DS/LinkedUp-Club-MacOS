...
class _MobileSettingsWidgetState extends State<MobileSettingsWidget>
              ...
              child: _buildIOSSection(
                ...
                children: [
                  _buildIOSListTile(
                    ...
                    onTap: () {
                      _showLanguagePicker(_translationLanguages);
                    },
                  ),
                  _buildIOSNotificationTile(
  ...
  void _showLanguagePicker(Map<String, String> languages) {
    showCupertinoModalPopup(
      context: context,
      builder: (BuildContext context) {
        return Container(
            ...
            child: CupertinoPicker(
              ...
              scrollController: FixedExtentScrollController(
                initialItem: languages.keys
                    .toList()
                    .indexOf(FFAppState().translateLanguage),
              ),
              onSelectedItemChanged: (int selectedItem) {
                setState(() {
                  FFAppState().translateLanguage =
                      languages.keys.toList()[selectedItem];
                });
              },
