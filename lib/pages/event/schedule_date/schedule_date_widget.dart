...
import 'schedule_date_model.dart';
export 'schedule_date_model.dart';

/// create an event creation that have speaker and info of the event
class ScheduleDateWidget extends StatefulWidget {
  ...
  final int? index;
  final Future Function(int thisIndex)? callbackAction;
  final bool isEdit;
  final String? title;
  ...
  final LatLng? lagLng;
  final String? noteSchedule;
  final List<SpeakerStruct>? selectedSpeakers;
...
class _ScheduleDateWidgetState extends State<ScheduleDateWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ScheduleDateModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (widget.isEdit == true) {
        ...
        _model.location = widget.location;
        _model.lagLng = widget.lagLng;
        _model.speakers =
            widget.selectedSpeakers!.toList().cast<SpeakerStruct>();
        _model.updatePage(() {});
        _model.loading = true;
        safeSetState(() {});
      } else {
    ...
    _model.textController3 ??=
        TextEditingController(text: widget.noteSchedule);
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'Schedule Location Note',
                                hintStyle: FlutterFlowTheme.of(context)
                                    .bodyLarge
                                    .override(
                                      font: GoogleFonts.inter(
                                      ...
                                      return ListView.separated(
                                        ...
                                        itemBuilder: (context, speakerIndex) {
                                          ...
                                          return InkWell(
                                            ...
                                            onTap: () async {
                                              if (_model.speakers
                                                  .contains(speakerItem)) {
                                                _model.removeFromSpeakers(
                                                    speakerItem);
                                                safeSetState(() {});
                                              } else {
                                                _model
                                                    .addToSpeakers(speakerItem);
                                                safeSetState(() {});
                                              }
                                            },
                                            child: Container(
                                    ...
                                    : () async {
                                        if (widget.isEdit == true) {
                                          FFAppState()
                                            ...
                                            (e) => e
                                              ..updateSchedule(
                                                (e) => e[widget.scheduleIndex!]
                                                  ..name = _model
                                                      .textController1.text
                                                  ..speaker =
                                                      _model.speakers.toList()
                                                  ..location = _model.placePickerValue
                                                      ...
                                                      : _model.placePickerValue
                                                          .latLng
                                                  ..locationName = _model.placePickerValue
                                                                  .address ==
                                                              ''
                                                      ? widget.location
                                                      : _model.placePickerValue
                                          ...
                                          FFAppState()
                                            ...
                                            (e) => e
                                              ..updateSchedule(
                                                (e) => e.add(ScheduleStruct(
                                                  name: _model
                                                      .textController1.text,
                                                  speaker: _model.speakers,
                                                  location: _model
