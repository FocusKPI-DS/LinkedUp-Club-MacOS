...
class _UserSummaryWidgetState extends State<UserSummaryWidget> {
  ...
  void initState() {
    ...
    // Auto-sync email if it was changed via verification link
    _syncEmailIfNeeded();
  }

  /// Check if the Auth email differs from Firestore and sync if needed.
  Future<void> _syncEmailIfNeeded() async {
    try {
      final callable = FirebaseFunctions.instance.httpsCallable('syncEmailAfterVerification');
      final result = await callable.call();
      if (result.data['synced'] == true && mounted) {
        setState(() {}); // Trigger rebuild to show updated email
      }
    } catch (e) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          ...
          colors: [Color(0xFF0077B5), Color(0xFF004182)],
        ),
  ...
  Future<void> _startChat(UsersRecord user) async {
    try {
      final chatToOpen = await ChatHelpers.findOrCreateDirectChat(
        user.reference,
      );
      ...
      if (context.mounted) {
        ...
        if (kIsWeb || (!kIsWeb && Platform.isMacOS)) {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => MobileChatWidget(initialChat: chatToOpen),
            ),
          );
        }
      }
  ...
  /// Sends a verification email via Cloud Function. Email updates after verification.
  void _showChangeEmailDialog(BuildContext context, UsersRecord profileUser) {
            ...
            return Center(
              child: Material(
                ...
                child: Container(
                  ...
                  child: isSent
                      ? _buildSuccessContent(dialogContext, sentToEmail)
                      : _buildInputContent(
                          dialogContext,
                          setDialogState,
                          emailController,
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Icon(CupertinoIcons.person_circle, size: 18, color: Color(0xFF64748B)),
                    SizedBox(width: 8),
                    Expanded(
                      child: Text(
                        profileUser.email,
              ...
              Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: (errorText != null ? Color(0xFFEF4444) : Color(0xFF2563EB)).withOpacity(0.08),
                      blurRadius: 8,
                      offset: Offset(0, 2),
                    ),
                  ],
                ...
                child: CupertinoTextField(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(
                      color: errorText != null ? Color(0xFFEF4444) : Color(0xFFD1D5DB),
                      width: 1.5,
                    ),
                  ),
                  prefix: Padding(
                    ...
                    child: Icon(
                      CupertinoIcons.mail,
                      size: 18,
                      color: errorText != null ? Color(0xFFEF4444) : Color(0xFF9CA3AF),
                    ),
                  ),
                  style: TextStyle(
                    fontFamily: 'SF Pro Display',
              ...
              if (errorText != null) ...[
                ...
                Row(
                  children: [
                    Icon(CupertinoIcons.exclamationmark_circle, size: 14, color: Color(0xFFEF4444)),
                    SizedBox(width: 6),
                    Expanded(
                      child: Text(
                        errorText!,
              ...
              // Info text
              Text(
                'A verification link will be sent to the new email. Your email will update after you click the link.',
                style: TextStyle(
                  fontFamily: 'SF Pro Display',
                  fontSize: 12,
                ...
                children: [
                  Expanded(
                    child: GestureDetector(
                      onTap: isSending ? null : () => Navigator.pop(dialogContext),
                      child: Container(
                    ...
                    child: GestureDetector(
                      onTap: isSending
                          ...
                          : () async {
                              ...
                              if (newEmail.isEmpty) {
                                setDialogState(() => setError('Please enter an email address'));
                                return;
                              }
                              if (!RegExp(r'^[^@\s]+@[^@\s]+\.[^@\s]+$').hasMatch(newEmail)) {
                                setDialogState(() => setError('Please enter a valid email address'));
                                return;
                              }
                              if (newEmail.toLowerCase() == profileUser.email.toLowerCase()) {
                                setDialogState(() => setError('This is already your current email'));
                                return;
                              }
                              ...
                              try {
                                ...
                                setDialogState(() => onSuccess(newEmail));
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            colors: isSending
                                ? [Color(0xFF93C5FD), Color(0xFF93C5FD)]
                        ...
                        child: Center(
                          child: isSending
                              ...
                              : Row(
                                  ...
                                  children: [
                                    Icon(CupertinoIcons.paperplane_fill, size: 16, color: Colors.white),
                                    SizedBox(width: 8),
                                    Text(
                                      'Send Verification',
                                      style: TextStyle(
  ...
  Widget _buildSuccessContent(BuildContext dialogContext, String email) {
    return Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        // Success header
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(CupertinoIcons.mail_solid, size: 16, color: Color(0xFF059669)),
                    SizedBox(width: 8),
                    Flexible(
                      child: Text(
                        email,
  ...
  void _showBlockUserConfirmation(UsersRecord user, UsersRecord currentUser) {
    showCupertinoDialog(
      context: context,
      builder: (context) => CupertinoAlertDialog(
    ...
    return AdaptivePopupMenuButton.widget<String>(
      items: [
        AdaptivePopupMenuItem(
          label: 'View photo',
          icon: PlatformInfo.isIOS26OrHigher() ? 'eye' : CupertinoIcons.eye,
          value: 'view',
        ),
        AdaptivePopupMenuItem(
          label: 'Edit photo',
      ...
      child: Container(
        ...
        child: Icon(CupertinoIcons.pencil, color: Colors.white, size: 14),
      ),
    );
  }
        ...
        return DesktopSafeUserPollBuilder(
          ...
          builder: (context, currentUser) {
            ...
            return CupertinoPageScaffold(
              ...
              child: SafeArea(
                top:
                    !isInSettings, // Remove top padding when in desktop settings
                child: isInSettings
                                        ...
                                        if (profileUser.interests.isNotEmpty ||
                                          ...
                                          widget.isEditable &&
                                              ...
                                              : Wrap(
                                                  ...
                                                  children: profileUser.interests.map((
                                                    interest,
                                                  ) {
                                                    return Container(
                                                      padding:
                                              ...
                                              children: [
                                                ...
                                                if (widget.isEditable &&
                                                  ...
                                                  Positioned(
                                                    ...
                                                    right: 0,
                                                    child:
                                                        _buildPhotoEditButton(
                                                          isCoverPhoto: false,
                                                          photoUrl: profileUser
                                                              .photoUrl,
                                                          user: profileUser,
                                                        ),
                                                  ),
