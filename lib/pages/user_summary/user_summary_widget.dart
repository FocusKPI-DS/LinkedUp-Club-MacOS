...
class _UserSummaryWidgetState extends State<UserSummaryWidget> {
  ...
  Future<void> _startChat(UsersRecord user) async {
    try {
      // Query all direct chats with this user
      ...
      // Find all direct chats with this user
      List<ChatsRecord> matchingChats = [];
      ...
      // Prefer the chat with messages (non-empty lastMessage)
      ...
      // If no chat with messages found, use any matching chat
