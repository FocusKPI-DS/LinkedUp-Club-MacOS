...
/// I want to create an page that show about user infomation and a button for
/// edit.
///
/// Basically an edit profile page
...
class _EditProfileWidgetState extends State<EditProfileWidget>
  ...
  void initState() {
    ...
    _model.textController5 ??= TextEditingController(text: 'March 15, 1992');
    _model.textFieldFocusNode5 ??= FocusNode();

    _model.eventUpdateValue =
        valueOrDefault<bool>(currentUserDocument?.notificationsEnabled, false);
    _model.newMessageValue =
        valueOrDefault<bool>(currentUserDocument?.newMessageEnabled, false);
    _model.connectionRequestsValue = valueOrDefault<bool>(
        currentUserDocument?.connectionRequestsEnabled, false);
                              ...
                              children: [
                                    ...
                                    onTap: () async {
                                      ...
                                      if (selectedMedia != null &&
                                        ...
                                        try {
                                          ...
                                          _model.isDataUploading_uploadDataDxd =
                                              false;
                                        }
                                        if (selectedUploadedFiles.length ==
                                            ...
                                            downloadUrls.length ==
                                                selectedMedia.length) {
                                          safeSetState(() {
                                            _model.uploadedLocalFile_uploadDataDxd =
                                                selectedUploadedFiles.first;
                                            _model.uploadedFileUrl_uploadDataDxd =
                                                downloadUrls.first;
                                          });
                                        } else {
                                          safeSetState(() {});
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 19.0),
                                  child: Text(
                                    'Tap the photo to change the profile.',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          font: GoogleFonts.inter(
