...
class FFAppState extends ChangeNotifier {
  ...
  Future initializePersistedState() async {
    ...
    _safeInit(() {
      ...
      _safeInit(() {
        final stored = prefs.getString('ff_translateLanguage');
        if (stored != null) {
      ...
      _safeInit(() {
        _aiTranslationEnabled =
            prefs.getBool('ff_aiTranslationEnabled') ?? _aiTranslationEnabled;
      });

      _safeInit(() {
        final stored = prefs.getString('ff_aiTranslationTargetLanguage');
        if (stored != null) {
          _aiTranslationTargetLanguage = stored;
        }
      });
      _safeInit(() {
  ...
  // 'system' = Use system language (default)
  // 'en', 'es', 'zh-cn', etc. = Specific language code
  String _translateLanguage = 'system';
  ...
  set aiTranslationEnabled(bool value) {
    ...
    prefs.setBool('ff_aiTranslationEnabled', value);
    notifyListeners();
  }

  String _aiTranslationTargetLanguage = 'en';
  String get aiTranslationTargetLanguage => _aiTranslationTargetLanguage;
  set aiTranslationTargetLanguage(String value) {
    _aiTranslationTargetLanguage = value;
    prefs.setString('ff_aiTranslationTargetLanguage', value);
    notifyListeners();
  }

  // Chat Font Size preference
