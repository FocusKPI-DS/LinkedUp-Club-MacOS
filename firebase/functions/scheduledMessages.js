...
exports.scheduledMessagesSend = functions.pubsub.schedule("* * * * *").onRun(async (context) => {
  const now = admin.firestore.Timestamp.now();
  
  console.log(`[scheduledMessagesSend] Running at ${now.toDate().toISOString()}`);
  ...
  console.log(`[scheduledMessagesSend] Found ${snapshot.size} pending messages to send`);
