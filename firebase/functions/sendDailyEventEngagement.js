...
exports.eventbriteOAuth = functions.https.onCall(async (data, context) => {
  ...
  const CLIENT_ID = process.env.EVENTBRITE_CLIENT_ID || 'YOUR_EVENTBRITE_CLIENT_ID';
  const CLIENT_SECRET = process.env.EVENTBRITE_CLIENT_SECRET || 'YOUR_EVENTBRITE_CLIENT_SECRET';
  const REDIRECT_URI = process.env.EVENTBRITE_REDIRECT_URI || 'https://linkedup-c3e29.web.app/eventbrite-callback';
...
exports.eventbriteOAuthCallback = functions.https.onRequest(async (req, res) => {
  ...
  try {
    ...
    const CLIENT_ID = process.env.EVENTBRITE_CLIENT_ID || 'YOUR_EVENTBRITE_CLIENT_ID';
    const CLIENT_SECRET = process.env.EVENTBRITE_CLIENT_SECRET || 'YOUR_EVENTBRITE_CLIENT_SECRET';
    const REDIRECT_URI = process.env.EVENTBRITE_REDIRECT_URI || 'https://linkedup-c3e29.web.app/eventbrite-callback.html';
...
exports.createStripeCheckout = functions.https.onCall(async (data, context) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: 'payment',
      success_url: `${process.env.APP_URL || 'https://linkedup-c3e29.web.app'}/paymentSuccess/${eventId}?payment=success&sessionId={CHECKOUT_SESSION_ID}`,
      cancel_url: `${process.env.APP_URL || 'https://linkedup-c3e29.web.app'}/paymentSuccess/${eventId}?payment=cancelled`,
