...
// MailerSend API configuration using environment variables (Firebase v2/v1 newer approach)
const MAILERSEND_API_KEY = process.env.MAILERSEND_API_KEY || "";
const MAILERSEND_FROM_EMAIL = process.env.MAILERSEND_FROM_EMAIL || "noreply@lona.club";
const MAILERSEND_FROM_NAME = process.env.MAILERSEND_FROM_NAME || "Lona";

exports.sendWorkspaceInviteEmail = functions.https.onCall(async (data, context) => {
