        ...
        <div className={styles.container}>
          <div className={styles.downloadCard}>
            ...
            <div className={styles.downloadButtons}>
              <a href="https://github.com/FocusKPI-DS/LinkedUp-Club-MacOS/releases/latest/download/Lona.dmg" className={`${styles.downloadButton} ${styles.downloadButtonPrimary}`} id="download-mac-button">
